...
final statusLevel = [
  ...
  StatusModel(
    ...
    darkColor: Color(0xFF966C00),
    lightColor: Color(0xFFFFFBA0),
    detailFontColor: Colors.black,
  ...
  StatusModel(
    ...
    darkColor: Color(0xFFB84F15),
    lightColor: Color(0xFFE09A66),
    detailFontColor: Colors.black,
  ...
  StatusModel(
    level: 6,
    label: '매우 나쁨',
    primaryColor: Color(0xFFFF0048),
    darkColor: Color(0xFFBA081D),
    lightColor: Color(0xFFF689A4),
    detailFontColor: Colors.black,
    imagePath: 'asset/img/worse.png',
    comment: '공기가 매우 나빠요! 나가지 마세요.',
    minFineDust: 101,
    minUltraFineDust: 51,
    minO3: 0.15,
    minNO2: 0.2,
